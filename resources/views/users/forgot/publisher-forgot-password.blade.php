...
<head>
    ...
    <title>Publisher | Lupa Password</title>
...
<body class="text-center">
    <main class="form-signin w-100 m-auto">
        <form action="{{route('publisher-update-password')}}" method="POST">
            @csrf
            @method('put')
            ...
            <div class="form-floating mb-2">
                <input type="text" class="form-control" placeholder="username" style="background-color: #FFFDD0; color:#291F1E" name="username" id="userName" autofocus>
