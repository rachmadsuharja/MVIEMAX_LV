                ...
                <form action="{{route('store-publisher')}}" method="POST">
                    @csrf
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="username" value="" id="username" placeholder="Username..." aria-label="default input example">
                            @error('username')
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="number" name="no_telp" value="" id="no_telp" placeholder="Telpon..." aria-label="default input example">
                            @error('no_telp')
                                <div class="alert alert-transparent p-0 text-white-50 mt-1"><i class="fa-solid fa-circle-exclamation"></i> {{$message}} </div>
                            @enderror
                        </div>
