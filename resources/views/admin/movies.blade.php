...
<div class="m-5 p-3 rounded" style="background-color: rgba(0,0,0, .5); box-shadow: 0px 2px 4px rgb(53, 53, 53)">
    <form action="/admin/all-movies" method="get">
        <div class="tbHead w-100 d-flex align-items-center">
    ...
    <table id="table" class="table mt-0" style="color: #dddd;">
        <thead>
            ...
            @foreach ($films as $film)
                <tr>
                    <th class="border-secondary">
                        <form method="post" id="deleteData" action="{{route('rm-movie', ['id' => $film->id])}}" onsubmit="confirmDelete(event)">
                            @csrf
                            @method('Delete')
                    ...
                    <td class="border-secondary"><img src="{{asset('img/temp/' . $film->img_cover)}}" width="100"></td>
